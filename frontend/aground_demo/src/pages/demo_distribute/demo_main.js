...
const Demo_main = () => {
  ...
  return (
    <div>
      ...
      <MainLayout imgsrc={main3} bgColor="#616161" onClick={() => navigate('/display/main')}>확인</MainLayout>
      <MainLayout imgsrc={main4} bgColor="#616161" onClick={() => navigate('/display/main')}>확인</MainLayout>
