        ...
        <div className={styles.MainSection3}>
            ...
            <div className={styles.boxgroup}>
                <div className={styles.box1}>
                    <div className={styles.inbox1}><Image className={styles.img} src={MainSection3_1} /></div>
                    <div className={styles.inbox4}><p className={styles.text}>리그 & 컵</p><p className={styles.conf1}>확인 &gt;</p></div>
                </div>
                <div className={styles.box1}>
                    <div className={styles.inbox2}><Image className={styles.img} src={MainSection3_2} /></div>
                    <div className={styles.inbox4}><p className={styles.text}>팀</p><p className={styles.conf2}>확인 &gt;</p></div>
                </div>
                <div className={styles.box1}>
                    <div className={styles.inbox3}><Image className={styles.img} src={MainSection3_3} /></div>
