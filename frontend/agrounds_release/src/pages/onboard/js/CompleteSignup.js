...
const CompleteSignup = () => {
  ...
  const startIndividual = () => {
    sessionStorage.setItem('userType', 'individual');
    navigate('/app/main')
  }
  ...
  return (
    <div className='completeBG'>
      ...
      <CircleBtn backgroundColor="#F2F4F8" color="#4D5358" title="개인으로 시작하기" onClick={startIndividual}/>
      <div className='blank'></div>
      <CircleBtn backgroundColor="#F2F4F8" color="#4D5358" title="팀 생성하기" onClick={() => navigate('/app/maketeam')}/>
