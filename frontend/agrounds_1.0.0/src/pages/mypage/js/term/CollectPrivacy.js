      ...
      <div className="header-container">
        <div className="header">
          ...
          <div className="header-content">
            <h1 className="text-h2">개인정보 수집 및 이용 동의</h1>
            <p className="subtitle text-body">AGROUNDS 서비스 이용을 위한 개인정보 처리방침</p>
          </div>
        </div>
      </div>
      
      <div className='content'>
        <img src={service1} className='img' alt='개인정보 수집 약관 1' />
        <img src={service2} className='img' alt='개인정보 수집 약관 2' />
        <img src={service3} className='img' alt='개인정보 수집 약관 3' />
        <img src={service4} className='img' alt='개인정보 수집 약관 4' />
        <img src={service5} className='img' alt='개인정보 수집 약관 5' />
      </div>
    </CollectPrivacyStyle>
  );
};
